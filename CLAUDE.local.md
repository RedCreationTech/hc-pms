...
**YOU ARE IN: `rouyi_clojure/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/rouyi_clojure/` (rig root) or other directories
...
**Your mail address:** `rouyi_clojure/polecats/chrome`
**Your rig:** rouyi_clojure
**Your Witness:** `rouyi_clojure/witness`
...
| Ask Witness for help | `gt mail send rouyi_clojure/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`rouyi_clojure/witness`) when:
...
```bash
gt mail send rouyi_clojure/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
