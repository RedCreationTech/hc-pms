...
--;;
INSERT IGNORE INTO sys_role_menu (role_id, menu_id) VALUES (1, 1000), (1, 1001), (1, 1002), (1, 1003), (1, 1004), (1, 1005), (1, 1006), (1, 1007), (1, 1008), (1, 1009), (1, 1010), (1, 1011), (1, 1012), (1, 1013), (1, 1014), (1, 1015), (1, 1016), (1, 1017), (1, 1018), (1, 1019), (1, 1020), (1, 1021), (1, 1022), (1, 1023), (1, 1024), (1, 1025), (1, 1026), (1, 1027), (1, 1028), (1, 1029), (1, 1030), (1, 1031), (1, 1032), (1, 1033), (1, 1034), (1, 1035), (1, 1036), (1, 1037), (1, 1038), (1, 1039), (1, 1040), (1, 1041), (1, 1042), (1, 1043), (1, 1044), (1, 1045), (1, 1046), (1, 1047), (1, 1048), (1, 1049), (1, 1050), (1, 1051), (1, 1052), (1, 1053), (1, 1054), (1, 1055), (1, 1056), (1, 1057), (1, 1058), (1, 1059), (1, 1060), (1, 1061), (1, 1062);
--;;
UPDATE sys_menu SET perms = 'bpm:instance:manage' WHERE menu_id = 48;
--;;
INSERT IGNORE INTO sys_role_menu (role_id, menu_id) VALUES (2, 30), (2, 31), (2, 33), (2, 34), (2, 35), (2, 52), (2, 302), (2, 303), (2, 304), (2, 305), (2, 328), (2, 329), (2, 330);
--;;
