-- 回退蓝图对齐扩展: 删除新增菜单/权限与配置表, 重建治理/交付记录为扩展前的类型约束 (丢弃扩展类型记录), 并删除计划任务与工时新增列.
...
--;;
ALTER TABLE pms_plan_task DROP COLUMN node_id;
--;;
ALTER TABLE pms_plan_task DROP COLUMN stage_code;
--;;
ALTER TABLE pms_time_entry DROP COLUMN corrects_entry_id;
--;;
ALTER TABLE pms_time_entry DROP COLUMN correction_reason;
--;;
