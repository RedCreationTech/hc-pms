CREATE TABLE pms_reopen_request (
 ...
 reason LONGTEXT NOT NULL, scope LONGTEXT NOT NULL, status VARCHAR(20) NOT NULL,
 review_note LONGTEXT, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, reviewed_at TIMESTAMP NULL,
...
CREATE TABLE pms_inbox (
 ...
 payload_hash VARCHAR(64) NOT NULL, payload_json LONGTEXT NOT NULL, status VARCHAR(20) NOT NULL,
...
CREATE TABLE pms_external_fact (
 ...
 message_id VARCHAR(36) NOT NULL, payload_hash VARCHAR(64) NOT NULL, payload_json LONGTEXT NOT NULL,
...
CREATE TABLE pms_outbox (
 ...
 payload_json LONGTEXT NOT NULL, payload_hash VARCHAR(64) NOT NULL, status VARCHAR(20) NOT NULL,
