INSERT IGNORE INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, menu_type, visible, status, perms, icon) VALUES
...
--;;
INSERT IGNORE INTO biz_solution (id, engineering_id, project_id, engineering_name, project_name, solution_name, status, progress) VALUES
