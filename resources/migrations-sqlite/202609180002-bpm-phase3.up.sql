-- BPM Phase 3 治理能力:模型扩展字段 + 实例单号/名称(SQLite)
...
--;;
ALTER TABLE biz_bpm_model ADD COLUMN auto_approval_type TEXT NOT NULL DEFAULT 'NONE';
--;;
ALTER TABLE biz_bpm_model ADD COLUMN name_rule TEXT;
--;;
...
--;;
ALTER TABLE biz_bpm_instance ADD COLUMN name TEXT NOT NULL DEFAULT '';
--;;
ALTER TABLE biz_bpm_instance ADD COLUMN bill_code TEXT;
--;;
