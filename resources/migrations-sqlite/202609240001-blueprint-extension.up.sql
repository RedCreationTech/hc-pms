-- 蓝图对齐扩展: 平台级版本化配置表, 治理/交付记录新增类型, 计划任务结构节点与阶段映射, 工时更正链, 新增菜单与权限.
...
--;;
INSERT OR IGNORE INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,component,menu_type,visible,status,perms,icon) VALUES (5003,'模板与规则',5000,3,'config','pms/config/index','C','0','0','pms:config:list','setting');
--;;
INSERT OR IGNORE INTO sys_role_menu(role_id,menu_id) VALUES (1,5003);
--;;
INSERT OR IGNORE INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,component,menu_type,visible,status,perms,icon) VALUES (5004,'项目组合看板',5000,4,'portfolio','pms/portfolio/index','C','0','0','pms:dashboard:query','appstore');
--;;
INSERT OR IGNORE INTO sys_role_menu(role_id,menu_id) VALUES (1,5004);
--;;
INSERT OR IGNORE INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,component,menu_type,visible,status,perms,icon) VALUES (5005,'我的待办',5000,5,'todo','pms/todo/index','C','0','0','pms:project:list','bell');
--;;
INSERT OR IGNORE INTO sys_role_menu(role_id,menu_id) VALUES (1,5005);
--;;
INSERT OR IGNORE INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,component,menu_type,visible,status,perms,icon) VALUES (5006,'全局检索',5000,6,'search','pms/search/index','C','0','0','pms:project:list','search');
--;;
INSERT OR IGNORE INTO sys_role_menu(role_id,menu_id) VALUES (1,5006);
--;;
INSERT OR IGNORE INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,component,menu_type,visible,status,perms,icon) VALUES (5007,'经营目标看板',5000,7,'targets','pms/targets/index','C','0','0','pms:finance:query','fund');
--;;
INSERT OR IGNORE INTO sys_role_menu(role_id,menu_id) VALUES (1,5007);
--;;
INSERT OR IGNORE INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,component,menu_type,visible,status,perms,icon) VALUES (5042,'模板与规则维护',5003,1,'','','F','0','0','pms:config:edit','#');
--;;
INSERT OR IGNORE INTO sys_role_menu(role_id,menu_id) VALUES (1,5042);
--;;
INSERT OR IGNORE INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,component,menu_type,visible,status,perms,icon) VALUES (5043,'机密文档访问',5001,22,'','','F','0','0','pms:document:confidential','#');
--;;
INSERT OR IGNORE INTO sys_role_menu(role_id,menu_id) VALUES (1,5043);
--;;
INSERT OR IGNORE INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,component,menu_type,visible,status,perms,icon) VALUES (5044,'经营目标维护',5007,1,'','','F','0','0','pms:target:edit','#');
--;;
INSERT OR IGNORE INTO sys_role_menu(role_id,menu_id) VALUES (1,5044);
--;;
