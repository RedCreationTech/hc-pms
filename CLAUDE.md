...
**YOU ARE IN: `ruoyi_clojure/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ruoyi_clojure/` (rig root) or other directories
...
**Your mail address:** `ruoyi_clojure/polecats/chrome`
**Your rig:** ruoyi_clojure
**Your Witness:** `ruoyi_clojure/witness`
...
| Ask Witness for help | `gt mail send ruoyi_clojure/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ruoyi_clojure/witness`) when:
...
```bash
gt mail send ruoyi_clojure/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
