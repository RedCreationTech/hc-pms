...
| [15 演示视频分镜与字幕](15-demo-video-storyboard.md) | 11 个功能节点章节卡, 48 个镜头的画面/动作/字幕; 由 `scripts/demo-video/` 自动录屏, 渲染章节卡, 合成原创配乐与底部字幕 |
| [16 权限, 组织与审批流程整改](16-permission-org-workflow.md) | 2026-09-24 权限/组织/流程审计结论与若依对照, S1 安全与权限底线, S2 组织数据权限与菜单, S3 审批策略可配置的整改计划与实施记录 |
| [17 组织, 菜单与流程配置演示视频分镜](17-config-video-storyboard.md) | 一家公司多个部门的配置演示: 5 个章节卡, 17 个镜头 (部门与负责人, 角色菜单/按钮/数据权限, 权限效果与实时收回, 审批策略, 跨部门逐级审批) |
