      ...
      [:> Layout.Content {:style {:margin 0
       ...
       [error-boundary/boundary
        (case page
          ...
          :bpm-start [bpm-start/bpm-start-page]
          :bpm-done [bpm-done/bpm-done-page]
          :bpm-copy [bpm-copy/bpm-copy-page]
          :bpm-instance [bpm-instance/bpm-instance-page]
          :leave [leave-page/leave-page]
          :reimburse [reimburse-page/reimburse-page]
          :report [report-page/report-page]
          :bpm-model [bpm-model/bpm-model-page]
          :bpm-model-edit [bpm-model-editor/bpm-model-editor-page]
          :bpm-definition [bpm-definition/bpm-definition-page]
          :bpm-form [bpm-admin/bpm-admin-page {:module "form"}]
          :bpm-category [bpm-admin/bpm-admin-page {:module "category"}]
          :bpm-user-group [bpm-admin/bpm-admin-page {:module "user-group"}]
          :bpm-listener [bpm-admin/bpm-admin-page {:module "listener"}]
          :bpm-expression [bpm-admin/bpm-admin-page {:module "expression"}]
          :bpm-settings [bpm-admin/bpm-admin-page {:module "settings"}]
          :bpm-instance-manager [bpm-ops/instance-manager-page]
          :bpm-task-manager [bpm-ops/task-manager-page]
          :bpm-instance-ops [bpm-ops/instance-ops-page]
