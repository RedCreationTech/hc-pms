(ns com.ruoyi.frontend.pages.business.bpm-model
  "流程模型管理 —— 分类卡片分组视图（P1 对齐 vben model/index.vue）+ 在线设计(bpmn-js)。"
  (:require
   [reagent.core :as r]
   [re-frame.core :as rf]
   ...
   ["@ant-design/icons" :refer [ReloadOutlined PlayCircleOutlined EditOutlined SaveOutlined
                                ...
                                AlignLeftOutlined ClearOutlined PlusOutlined DownOutlined SearchOutlined]]
    ...
    [:div
     ...
     (if loading?
       ...
       [:div
        ...
        (case tab
          "basic" [basic-info-tab {:mname mname :set-mname! set-mname!
