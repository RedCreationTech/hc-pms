...
;; ── 日程 ──────────────────────────────────────────────────────────────
(defn calendar-list [{:keys [query-fn]} params]
...
(defn calendar-get [{:keys [query-fn]} id]
  (query-fn :oa/find-calendar-by-id {:calendar_id id}))

(defn calendar-create [{:keys [query-fn]} params user]
...
(defn calendar-update [{:keys [query-fn]} params user]
...
(defn calendar-delete [{:keys [query-fn]} id]
  (query-fn :oa/delete-calendar {:calendar_id id}))

;; ── 会议 ──────────────────────────────────────────────────────────────
(defn meeting-list [{:keys [query-fn]} params]
  (let [{:keys [offset size]} (page-params params)
...
(defn meeting-get [{:keys [query-fn]} id]
  (query-fn :oa/find-meeting-by-id {:meeting_id id}))

(defn meeting-create [{:keys [query-fn]} params user]
...
(defn meeting-update [{:keys [query-fn]} params user]
...
(defn meeting-delete [{:keys [query-fn]} id]
