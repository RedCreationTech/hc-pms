...
(defn- generate-domain [table-name entity kebab columns]
  (let [pk-col (or (first (filter col-pk? columns)) (first columns))
        ...
        update-fn (str "update-" kebab "!")
        delete-fn (str "delete-" kebab "!")]
    (str "(ns com.ruoyi.rouyi.domain.system." kebab "\n"
         "  \"" entity " 领域服务。\")\n\n"
         "(defn " list-fn "\n"
         "  \"查询" entity "列表。\"\n"
...
(defn- generate-controller [entity kebab pk-name]
  (str "(ns com.ruoyi.rouyi.web.controllers.system." kebab "\\n"
         "  \"" entity "管理控制器。\"\\n"
         "  (:require\\n   [com.ruoyi.rouyi.domain.system." kebab " :as " kebab "-service]\\n"
...
(defn- generate-frontend-page [kebab entity]
  (str "(ns com.ruoyi.rouyi.frontend.pages." kebab "\n"
         "  \"" entity "管理页面。\"\n"
